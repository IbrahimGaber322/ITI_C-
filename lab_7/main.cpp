...
int main()
{
    ...
    int totalShapes =numOfCirlces+numOfLines+numOfRectangles;
    shape * shapes[totalShapes];
    ...
    for(int i=0; i<numOfLines; i++){
        ...
        shapes[i]= new lin (_x1, _y1, _x2, _y2, _color);
    }

      for(int i=numOfLines; i<totalShapes-numOfRectangles; i++){
        ...
        shapes[i] = new circ(_x1,_y1,0,0,_color,_radius);
      }

       for(int i=totalShapes-numOfRectangles; i<totalShapes; i++){
          int _x1, _y1, _x2, _y2, _color =0;
        cout<<"Enter x1,y1 x2,y2 and color from 1 to 15 for rectangle no:"<< i+1<<endl;
        cin>> _x1>> _y1>> _x2>> _y2>> _color;
        shapes[i]= new rect (_x1, _y1, _x2, _y2, _color);
      }
